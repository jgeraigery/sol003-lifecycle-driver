...
/**
 * Represents a VNF identifier deletion notification, which informs the receiver of the deletion of a new VNF
 * instance resource and the associated VNF instance identifier.
 */
@Data
@JsonInclude(value = JsonInclude.Include.NON_EMPTY, content = JsonInclude.Include.NON_NULL)
@JsonIgnoreProperties(ignoreUnknown = true)
@Schema(description = "Represents a VNF identifier deletion notification, which informs the receiver of the deletion of a new VNF instance resource and the associated VNF instance identifier.")
public class VnfIdentifierDeletionNotification implements LifecycleManagementNotification {

    public static final String TYPE = "VnfIdentifierDeletionNotification";
    ...
    private String id;
    @Schema(name = "Notification Type", required = true, description = "Discriminator for the different notification types. Shall be set to \"VnfIdentifierDeletionNotification\" for this notification type.")
