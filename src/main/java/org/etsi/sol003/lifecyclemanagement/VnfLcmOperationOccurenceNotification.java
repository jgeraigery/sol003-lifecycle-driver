...
public class VnfLcmOperationOccurenceNotification implements LifecycleManagementNotification {
    ...
    @Schema(name = "Affected ExtLink Port", description = "Information about external VNF link ports that were affected during the lifecycle operation.")
    ...
    @Schema(name = "Modifications Triggered By VnfPkg Change", description = "Information about performed changes of \"VnfInstance\" attributes triggered by changing the current VNF package. Shall be present if the \"notificationStatus\" is set to \"RESULT\".")
