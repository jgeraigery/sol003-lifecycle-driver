...
public class VNFLifecycleManagementDriver {
    ...
    public void deleteVnfInstance(final ResourceManagerDeploymentLocation deploymentLocation, final String vnfInstanceId, final String driverrequestid) throws SOL003ResponseException {
        ...
        UUID uuid = UUID.randomUUID();
        LoggingUtils.logEnabledMDC(vnfInstanceId, MessageType.REQUEST,MessageDirection.SENT, uuid.toString(),MediaType.APPLICATION_JSON.toString(), "http",
    ...
    public void deleteLifecycleSubscription(final ResourceManagerDeploymentLocation deploymentLocation, final String subscriptionId) throws SOL003ResponseException {
        ...
        try {
            ...
            // To log all unknown errors while making external call
            LoggingUtils.logEnabledMDC(e.getMessage(),MessageType.RESPONSE,MessageDirection.RECEIVED,uuid.toString(),MediaType.APPLICATION_JSON.toString(), "http",
                    RequestResponseLogUtils.getResponseReceivedProtocolMetaData(HttpStatus.INTERNAL_SERVER_ERROR.value(), HttpStatus.INTERNAL_SERVER_ERROR.getReasonPhrase(), null),null);
            throw e;
        }
        LoggingUtils.logEnabledMDC(null, MessageType.RESPONSE,MessageDirection.RECEIVED,uuid.toString(),MediaType.APPLICATION_JSON.toString(), "http",
